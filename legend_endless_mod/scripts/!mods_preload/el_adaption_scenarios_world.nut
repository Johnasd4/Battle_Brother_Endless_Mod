...
::mods_queue(null, "el_player_npc", function ()
{
	...
	::mods_hookExactClass("scenarios/world/deserters_scenario", function(o){
        ...
        o.onSpawnPlayer = function()
        {
            ...
            bros[0].addXP(this.Const.LevelXP[1]);
            bros[0].updateLevel();
            local items = bros[0].getItems();
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Mainhand));
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Ammo));
            ...
            bros[1].addXP(this.Const.LevelXP[1]);
            bros[1].updateLevel();
            items = bros[1].getItems();
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Mainhand));
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Ammo));
            ...
            bros[2].addXP(this.Const.LevelXP[1]);
            bros[2].updateLevel();
            items = bros[2].getItems();
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Mainhand));
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Offhand));
	...
	::mods_hookExactClass("scenarios/world/legend_random_3_scenario", function(o){
        ...
        o.onSpawnAssets = function()
        {
            ...
            for( local i = 0; i < 3; i = i )
            {
                ...
                bro.m.HireTime = this.Time.getVirtualTimeF();
                bro.addXP(this.Const.LevelXP[2]);
                bro.updateLevel();
                i = ++i;
            }
	...
	::mods_hookExactClass("scenarios/world/legend_random_party_scenario", function(o){
        ...
        o.onSpawnAssets = function()
        {
            ...
            for( local i = 0; i < partysize; i = i )
            {
                ...
                bro.addXP(this.Const.LevelXP[broLevel - 1]);
                bro.updateLevel();
                i = ++i;
            }
	...
	::mods_hookExactClass("scenarios/world/legend_random_solo_scenario", function(o){
        ...
        o.onSpawnAssets = function()
        {
            ...
            local bros = roster.getAll();
            bros[0].addXP(this.Const.LevelXP[3]);
            bros[0].updateLevel();
	...
	::mods_hookExactClass("scenarios/world/legends_troupe_scenario", function(o){
        ...
        o.onSpawnAssets = function()
        {
            ...
            bros[0].addXP(this.Const.LevelXP[2]);
            bros[0].updateLevel();
            bros[0].setPlaceInFormation(13);
            ...
            bros[2].setPlaceInFormation(4);
            bros[2].addXP(this.Const.LevelXP[3]);
            bros[2].updateLevel();
            ...
            bros[3].addXP(this.Const.LevelXP[1]);
            bros[3].updateLevel();
	...
	::mods_hookExactClass("scenarios/world/raiders_scenario", function(o){
        ...
        o.onSpawnAssets = function()
        {
            ...
            bros[1].setPlaceInFormation(4);
            bros[1].addXP(this.Const.LevelXP[2]);
            bros[1].updateLevel();
            local items = bros[1].getItems();
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Body));
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Head));
            ...
            bros[2].setPlaceInFormation(5);
            bros[2].addXP(this.Const.LevelXP[2]);
            bros[2].updateLevel();
            local items = bros[2].getItems();
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Body));
            items.unequip(items.getItemAtSlot(this.Const.ItemSlot.Head));
