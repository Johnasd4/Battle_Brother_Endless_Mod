...
::mods_registerMod("el_adaption_events_events_special", 1, "el_adaption_events_events_special");
::mods_queue(null, "el_player_npc", function ()
{
	::mods_hookExactClass("events/events/special/oathtakers_confrontation_event", function(o){
