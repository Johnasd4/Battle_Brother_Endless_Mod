    ...
    ::mods_hookClass("items/item", function(o) {
		...
		o.getSellPrice = function()
		{
			...
			if (("State" in this.World) && this.World.State != null && this.World.State.getCurrentTown() != null)
			{
				foreach(entry in this.m.EL_EntryList)
				{
					if(entry.getID() == "el_weapon_entry.value_mult" && entry.m.EL_CurrentLevel == 1 || entry.getID() == "el_shield_entry.value_mult" && entry.m.EL_CurrentLevel == 1 || 
					   entry.getID() == "el_armor_entry.value_mult" && entry.m.EL_CurrentLevel == 1 || entry.getID() == "el_helmet_entry.value_mult" && entry.m.EL_CurrentLevel == 1 || 
					   entry.getID() == "el_accessory_entry.value_mult" && entry.m.EL_CurrentLevel == 1)
					{
