...
::mods_queue(null, "el_item", function ()
{
    ::mods_hookExactClass("items/weapons/weapon", function ( o )
	{
		...
		{
			return this.Const.EL_Weapon.EL_Essence.SlotFactor * this.Const.EL_Weapon.EL_Essence.UpgradeFactor * this.Math.floor(-1 * this.Math.min(-1, this.m.EL_BaseWithRankStaminaModifier) * (1 + this.Const.EL_Weapon.EL_LevelFactor.StaminaModifier * this.m.EL_Level));
		}

		o.EL_getDisassembleEssence <- function()
		{
			return this.Const.EL_Weapon.EL_Essence.SlotFactor * this.Const.EL_Weapon.EL_Essence.DisassembleFactor * this.Math.floor(-1 * this.Math.min(-1, this.m.EL_BaseWithRankStaminaModifier) * (1 + this.Const.EL_Weapon.EL_LevelFactor.StaminaModifier * this.m.EL_Level));
		}

		o.EL_getRecraftEssence <- function()
		{
			return this.Const.EL_Weapon.EL_Essence.SlotFactor * this.Const.EL_Weapon.EL_Essence.RecraftFactor * this.Math.floor(-1 * this.Math.min(-1, this.m.EL_BaseWithRankStaminaModifier) * (1 + this.Const.EL_Weapon.EL_LevelFactor.StaminaModifier * this.World.Assets.m.EL_WorldLevel));
		}
	});
