        ...
        o.summonWarden = function()
        {
            if (this.m.WardenSummonSpent == false && this.m.WardenEntity == null)
            {
                ...
                if (WardenSpawnTile != null)
                {
                    ...
                    local entity = this.Const.World.Common.EL_addEntityByScript("scripts/entity/tactical/legend_vala_warden_script", WardenSpawnTile, this.Const.Faction.PlayerAnimals, actor.EL_getRankLevel(), actor.EL_getCombatLevel());
