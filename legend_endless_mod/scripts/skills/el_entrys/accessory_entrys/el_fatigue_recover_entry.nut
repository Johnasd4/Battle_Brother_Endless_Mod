this.el_fatigue_recover_entry <- this.inherit("scripts/skills/el_entrys/el_accessory_entry", {
	...
	{
		if(this.m.EL_FatigueRecover > this.Const.EL_Accessory.EL_Entry.Factor.EL_FatigueRecover.FatigueRecover)
		{
	...
	{
		this.m.EL_FatigueRecover = this.Const.EL_Accessory.EL_Entry.EntryStrengthenMult * this.Const.EL_Accessory.EL_Entry.Factor.EL_FatigueRecover.FatigueRecover;
	}
