this.el_combat_level_entry <- this.inherit("scripts/skills/el_entrys/el_accessory_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_CombatLevel <= this.Const.EL_Accessory.EL_Entry.Factor.EL_CombatLevel.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_CombatLevel = this.Const.EL_Accessory.EL_Entry.Factor.EL_CombatLevel.BaseCombatLevel + this.Math.rand(randomMin, randomMax) * 0.01;
	}

	function EL_strengthen()
	{
		this.m.EL_CombatLevel = this.Const.EL_Accessory.EL_Entry.EntryStrengthenMult * this.Const.EL_Accessory.EL_Entry.Factor.EL_CombatLevel.ColourRange[this.Const.EL_Item.Type.Legendary];
	}
