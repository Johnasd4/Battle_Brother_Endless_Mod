this.el_hitpoints_recovery_rate_entry <- this.inherit("scripts/skills/el_entrys/el_accessory_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_HitpointsRecoveryRate <= this.Const.EL_Accessory.EL_Entry.Factor.EL_HitpointsRecoveryRate.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_HitpointsRecoveryRate = this.Const.EL_Accessory.EL_Entry.Factor.EL_HitpointsRecoveryRate.BaseHitpointsRecoveryRate + this.Math.rand(randomMin, randomMax) * 0.01;
	}

	function EL_strengthen()
	{
		this.m.EL_HitpointsRecoveryRate = this.Const.EL_Accessory.EL_Entry.EntryStrengthenMult * this.Const.EL_Accessory.EL_Entry.Factor.EL_HitpointsRecoveryRate.ColourRange[this.Const.EL_Item.Type.Legendary];
	}
