this.el_bravery_entry <- this.inherit("scripts/skills/el_entrys/el_accessory_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_Bravery <= this.Const.EL_Accessory.EL_Entry.Factor.EL_Bravery.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_Bravery = this.Const.EL_Accessory.EL_Entry.Factor.EL_Bravery.BaseBravery + this.Math.rand(randomMin, randomMax);
	}

	function EL_strengthen()
	{
		this.m.EL_Bravery = this.Const.EL_Accessory.EL_Entry.EntryStrengthenMult * this.Const.EL_Accessory.EL_Entry.Factor.EL_Bravery.ColourRange[this.Const.EL_Item.Type.Legendary];
	}
	...
	function EL_onUpgradeRank()
	{
		...
		{
			this.m.EL_Bravery += this.Const.EL_Accessory.EL_Entry.Factor.EL_Bravery.RandomMaxBravery[this.Const.EL_Item.Type.Normal] / 2;
		}
	}
