this.el_reduce_damage_received_mult_entry <- this.inherit("scripts/skills/el_entrys/el_accessory_entry", {
	...
	{
		this.m.EL_ReduceDamageReceivedMult = this.Math.pow(1.0 - this.Const.EL_Helmet.EL_Entry.Factor.EL_ReduceDamageReceivedMult.ColourRange[this.Const.EL_Item.Type.Legendary] * 0.01, this.Const.EL_Helmet.EL_Entry.EntryStrengthenMult) * 100;
	}
	...
	function EL_refreshTotalEntry( _EL_totalEntry )
	{
		...
		_EL_totalEntry.m.EL_HelmetDamageReceivedMult += this.Math.round(this.m.EL_CurrentLevel * this.m.EL_ReduceDamageReceivedMult * 100) * 0.01;
	}
