this.el_damage_head_reduction_entry <- this.inherit("scripts/skills/el_entrys/el_accessory_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_DamageHeadArmorReduction <= this.Const.EL_Helmet.EL_Entry.Factor.EL_DamageHeadArmorReduction.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_DamageHeadArmorReduction = this.Const.EL_Helmet.EL_Entry.Factor.EL_DamageHeadArmorReduction.BaseDamageHeadArmorReduction + this.Math.rand(randomMin, randomMax) * 0.1;
	}
	...
	function EL_onUpgradeRank()
	{
		...
		{
			this.m.EL_DamageHeadArmorReduction += this.Const.EL_Helmet.EL_Entry.Factor.EL_DamageHeadArmorReduction.RandomMaxDamageHeadArmorReduction[this.Const.EL_Item.Type.Normal] / 2 * 0.1;
		}
	}
	...
	function EL_onItemUpdate( _item )
	{
        ...
        _item.m.EL_DamageHeadArmorReduction += this.Math.ceil(this.m.EL_CurrentLevel * this.m.EL_DamageHeadArmorReduction * (1.0 + this.m.EL_Level * this.Const.EL_Helmet.EL_LevelFactor.DamageHeadArmorReduction));
	}
