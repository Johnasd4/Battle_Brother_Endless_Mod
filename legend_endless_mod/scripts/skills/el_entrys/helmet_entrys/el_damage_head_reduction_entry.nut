this.el_damage_head_reduction_entry <- this.inherit("scripts/skills/el_entrys/el_accessory_entry", {
	...
	{
		this.m.EL_Bonus = this.m.EL_DamageHeadArmorReduction * 0.01 * this.Math.abs(_item.m.EL_BaseNoRankStaminaModifier) * (1.0 + _item.m.EL_CurrentLevel * this.Const.EL_Helmet.EL_LevelFactor.DamageHeadArmorReduction);
