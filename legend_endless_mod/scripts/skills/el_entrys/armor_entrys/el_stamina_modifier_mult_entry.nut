this.el_stamina_modifier_mult_entry <- this.inherit("scripts/skills/el_entrys/el_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_StaminaModifierMultAddition <= this.Const.EL_Armor.EL_Entry.Factor.EL_StaminaModifierMult.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_StaminaModifierMultAddition = this.Const.EL_Armor.EL_Entry.Factor.EL_StaminaModifierMult.BaseStaminaModifierMult + this.Math.rand(randomMin, randomMax) * 0.01;
	}
	...
	{
		_EL_totalEntry.m.EL_ArmorStaminaModifierMultAddition += this.m.EL_StaminaModifierMultAddition;
	}
