this.el_damage_regular_reduction_entry <- this.inherit("scripts/skills/el_entrys/el_accessory_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_DamageBodyRegularReduction * 0.1 <= this.Const.EL_Armor.EL_Entry.Factor.EL_DamageBodyRegularReduction.ColourRange[index])
            {
	...
	{
		this.m.EL_DamageBodyRegularReduction = 10 * this.Const.EL_Armor.EL_Entry.EntryStrengthenMult * this.Const.EL_Armor.EL_Entry.Factor.EL_DamageBodyRegularReduction.ColourRange[this.Const.EL_Item.Type.Legendary];
	}
	...
	{
		this.m.EL_Bonus = this.m.EL_DamageBodyRegularReduction * 0.2 * (1.0 + _item.m.EL_CurrentLevel * this.Const.EL_Armor.EL_LevelFactor.DamageBodyRegularReduction);
