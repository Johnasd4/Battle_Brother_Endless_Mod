this.el_ranged_defense_entry <- this.inherit("scripts/skills/el_entrys/el_accessory_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_RangedDefense <= this.Const.EL_Armor.EL_Entry.Factor.EL_RangedDefense.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_RangedDefense = this.Const.EL_Armor.EL_Entry.Factor.EL_RangedDefense.BaseRangedDefense + this.Math.rand(randomMin, randomMax);
	}
