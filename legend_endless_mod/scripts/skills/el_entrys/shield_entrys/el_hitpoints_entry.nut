this.el_hitpoints_entry <- this.inherit("scripts/skills/el_entrys/el_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_HitpointsAddition <= this.Const.EL_Shield.EL_Entry.Factor.EL_Hitpoints.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_HitpointsAddition = this.Const.EL_Shield.EL_Entry.Factor.EL_Hitpoints.BaseHitpoints + this.Math.rand(randomMin, randomMax);
	}
