this.el_shield_reduce_damage_received_mult_entry <- this.inherit("scripts/skills/el_entrys/el_entry", {
	...
	{
		this.m.EL_ShieldDamageReceivedMult = this.Math.pow(1.0 - this.Const.EL_Shield.EL_Entry.Factor.EL_ShieldDamageReceivedMult.ColourRange[this.Const.EL_Item.Type.Legendary] * 0.01, this.Const.EL_Shield.EL_Entry.EntryStrengthenMult) * 100;
	}
