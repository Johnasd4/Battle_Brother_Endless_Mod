this.el_intimidate_npc_buff <- this.inherit("scripts/skills/el_npc_buffs/el_npc_buff", {
    ...
    function getDescription() {
		return "决心增加" + this.Const.EL_NPC.EL_NPCBuff.Factor.Intimidate.BraveryOffset[this.m.EL_RankLevel] + "点。每次攻击有" + this.Const.EL_NPC.EL_NPCBuff.Factor.Intimidate.MoraleCheckChance[this.m.EL_RankLevel] + "%的概率对周围敌人进行1次负面的决心判定，受自身决心影响。";
    }
