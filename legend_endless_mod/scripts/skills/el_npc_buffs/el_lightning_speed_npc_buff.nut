this.el_lightning_speed_npc_buff <- this.inherit("scripts/skills/el_npc_buffs/el_npc_buff", {
    ...
    function getDescription() {
		return "增加" + this.Const.EL_NPC.EL_NPCBuff.Factor.LightningSpeed.InitiativeOffset[this.m.EL_RankLevel] + "点主动值，行动点增加" + (this.Const.EL_NPC.EL_NPCBuff.Factor.LightningSpeed.ActionPointsMult[this.m.EL_RankLevel] - 1) * 100 + "%。";
    }
