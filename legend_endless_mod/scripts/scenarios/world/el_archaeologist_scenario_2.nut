this.el_archaeologist_scenario_2 <- this.inherit("scripts/scenarios/world/starting_scenario", {
	m = {
		OnInitOrigin = false,
		CanHire = false
	},
	...
	function onSpawnAssets()
	{
		...
		this.World.Flags.set("ELArchaeologistDifficulty", this.Const.Difficulty.Normal);
