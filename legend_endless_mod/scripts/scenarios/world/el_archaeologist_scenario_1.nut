this.el_archaeologist_scenario_1 <- this.inherit("scripts/scenarios/world/starting_scenario", {
	m = {
		OnInitOrigin = false,
		CanHire = false
	},
	...
	function onSpawnAssets()
	{
		...
		this.World.Flags.set("ELArchaeologistDifficulty", this.Const.Difficulty.Easy);
	...
	function onInit()
	{
		...
		this.World.Assets.m.BusinessReputationRate = 2.0;
	}
