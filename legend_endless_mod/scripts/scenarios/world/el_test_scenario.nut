...
//		bros[0].getSprite("miniboss").setBrush("bust_miniboss_lone_wolf");
		//bros[0].EL_setLevel(100);
		bros[0].m.BaseProperties.ActionPoints = 9999;
		bros[0].m.BaseProperties.Hitpoints = 9999;
		bros[0].m.BaseProperties.Bravery = 9999;
		bros[0].m.BaseProperties.Stamina = 9999;
		bros[0].m.BaseProperties.Initiative = 9999;
		bros[0].m.BaseProperties.MeleeSkill = 9999;
		bros[0].m.BaseProperties.RangedSkill = 9999;
		bros[0].m.BaseProperties.MeleeDefense = 9999;
		bros[0].m.BaseProperties.RangedDefense = 9999;
