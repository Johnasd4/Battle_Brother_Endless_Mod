this.el_archaeologist_scenario_3 <- this.inherit("scripts/scenarios/world/starting_scenario", {
	m = {
		OnInitOrigin = false,
		CanHire = false
	},
	...
	function onSpawnAssets()
	{
		...
		this.World.Flags.set("ELArchaeologistDifficulty", this.Const.Difficulty.Hard);
	...
	function onInit()
	{
		...
		this.World.Assets.m.BusinessReputationRate = 1.0;
	}
