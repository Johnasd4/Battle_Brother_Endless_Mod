this.el_disassemble_item_ambition_3 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_AmountNeed = 10000
	},
	function create()
	{
		...
		this.m.ID = "ambition.el_disassemble_item_3";
		this.m.Duration = 99999.0 * this.World.getTime().SecondsPerDay;
		this.m.ButtonText = "强化装备需要大量的精华，仅靠战场掉落的蚊子腿太少了，让我们去铁匠铺将不用的装备分解，获取更多精华！。";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_disassemble_item_2").isDone())
		{
			return;
		}
