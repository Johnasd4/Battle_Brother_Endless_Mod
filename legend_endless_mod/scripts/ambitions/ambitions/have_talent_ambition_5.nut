this.have_talent_ambition_5 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_ManNeed = 3,
        EL_TalentNeed = 32
    },
	function create()
	{
		...
		this.m.ID = "ambition.have_talent_5";
	...
	function onUpdateScore()
	{
		...
		if (!this.World.Ambitions.getAmbition("ambition.have_talent_4").isDone())
		{
			return;
		}
        this.m.Score = 0;
