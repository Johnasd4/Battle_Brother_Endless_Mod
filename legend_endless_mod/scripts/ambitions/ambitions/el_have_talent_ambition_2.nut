this.el_have_talent_ambition_2 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_ManNeed = 1,
        EL_TalentNeed = 24
    },
	function create()
	{
		...
		this.m.ID = "ambition.el_have_talent_2";
	...
	function onUpdateScore()
	{
		...
		if (!this.World.Ambitions.getAmbition("ambition.el_have_talent_1").isDone())
		{
			return;
		}
