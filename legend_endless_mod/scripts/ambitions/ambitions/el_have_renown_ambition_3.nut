this.el_have_renown_ambition_3 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_ReputationNeed = 10000
    },
	function create()
	{
		this.ambition.create();
		this.m.ID = "ambition.el_have_renown_3";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_have_renown_2").isDone())
		{
			return;
		}
