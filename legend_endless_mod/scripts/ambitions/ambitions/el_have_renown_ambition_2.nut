this.el_have_renown_ambition_2 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_ReputationNeed = 5000
    },
	function create()
	{
		this.ambition.create();
		this.m.ID = "ambition.el_have_renown_2";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_have_renown_1").isDone())
		{
			return;
		}
