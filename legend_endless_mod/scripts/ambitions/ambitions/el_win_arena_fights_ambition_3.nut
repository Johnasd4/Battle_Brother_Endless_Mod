this.el_win_arena_fights_ambition_3 <- this.inherit("scripts/ambitions/ambition", {
	m = {
		EL_ArenaLevelNeed = 4
	},
	function create()
	{
		...
		this.m.ID = "ambition.el_win_arena_fights_3";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_win_arena_fights_2").isDone())
		{
			return;
		}
