this.have_talent_ambition_3 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_ManNeed = 3,
        EL_TalentNeed = 24
    },
	function create()
	{
		...
		this.m.ID = "ambition.have_talent_3";
	...
	function onUpdateScore()
	{
		...
		if (!this.World.Ambitions.getAmbition("ambition.have_talent_2").isDone())
		{
			return;
		}
        this.m.Score = 0;
