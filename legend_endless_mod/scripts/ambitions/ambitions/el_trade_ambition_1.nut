this.el_trade_ambition_1 <- this.inherit("scripts/ambitions/ambition", {
	m = {
		AmountToBuy = 0,
		AmountToSell = 0
        EL_AmountNeed = 50
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_trade_0").isDone())
		{
			return;
		}
