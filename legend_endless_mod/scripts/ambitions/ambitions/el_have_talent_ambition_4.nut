this.el_have_talent_ambition_4 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_ManNeed = 1,
        EL_TalentNeed = 32
    },
	function create()
	{
		...
		this.m.ID = "ambition.el_have_talent_4";
	...
	function onUpdateScore()
	{
		...
		if (!this.World.Ambitions.getAmbition("ambition.el_have_talent_3").isDone())
		{
			return;
		}
