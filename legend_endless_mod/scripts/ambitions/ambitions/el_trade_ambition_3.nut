this.el_trade_ambition_3 <- this.inherit("scripts/ambitions/ambition", {
	m = {
		AmountToBuy = 0,
		AmountToSell = 0
        EL_AmountNeed = 500
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_trade_2").isDone())
		{
			return;
		}
