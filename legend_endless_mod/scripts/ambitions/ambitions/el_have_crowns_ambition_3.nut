this.el_have_crowns_ambition_3 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_CrownsNeed = 1000000
    },
	function create()
	{
		this.ambition.create();
		this.m.ID = "ambition.el_have_crowns_3";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_have_crowns_2").isDone())
		{
			return;
		}
