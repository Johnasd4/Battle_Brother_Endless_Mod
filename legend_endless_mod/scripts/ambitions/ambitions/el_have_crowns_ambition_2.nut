this.el_have_crowns_ambition_2 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_CrownsNeed = 400000
    },
	function create()
	{
		this.ambition.create();
		this.m.ID = "ambition.el_have_crowns_2";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_have_crowns_1").isDone())
		{
			return;
		}
