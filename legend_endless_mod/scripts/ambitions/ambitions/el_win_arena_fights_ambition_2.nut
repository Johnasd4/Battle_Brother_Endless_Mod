this.el_win_arena_fights_ambition_2 <- this.inherit("scripts/ambitions/ambition", {
	m = {
		EL_ArenaLevelNeed = 3
	},
	function create()
	{
		...
		this.m.ID = "ambition.el_win_arena_fights_2";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_win_arena_fights_1").isDone())
		{
			return;
		}
