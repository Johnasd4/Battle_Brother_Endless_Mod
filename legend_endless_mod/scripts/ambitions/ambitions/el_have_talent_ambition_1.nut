this.el_have_talent_ambition_1 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_ManNeed = 3,
        EL_TalentNeed = 16
    },
	function create()
	{
		...
		this.m.ID = "ambition.el_have_talent_1";
	...
	function onUpdateScore()
	{
		...
		if (!this.World.Ambitions.getAmbition("ambition.el_have_talent_0").isDone())
		{
			return;
		}
