this.el_have_crowns_ambition_1 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_CrownsNeed = 100000
    },
	function create()
	{
		this.ambition.create();
		this.m.ID = "ambition.el_have_crowns_1";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_have_crowns_0").isDone())
		{
			return;
		}
