this.el_armor_ambition_3 <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.TooltipText = "拥有3件至少3阶的盔甲和头盔，每件装备都有300或以上的基础耐久（耐久值右侧括号里的数字）。 Whether you buy them or loot them off of the battlefield, they will protect your men equally well.";
