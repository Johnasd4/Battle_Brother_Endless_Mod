this.el_trade_ambition_2 <- this.inherit("scripts/ambitions/ambition", {
	m = {
		AmountToBuy = 0,
		AmountToSell = 0
        EL_AmountNeed = 200
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_trade_1").isDone())
		{
			return;
		}
