this.el_upgrade_item_ambition_2 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_AmountNeed = 40000
	},
	function create()
	{
		...
		this.m.ID = "ambition.el_upgrade_item_2";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_upgrade_item_1").isDone())
		{
			return;
		}
