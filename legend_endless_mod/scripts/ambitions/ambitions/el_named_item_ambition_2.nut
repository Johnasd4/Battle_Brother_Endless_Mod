this.el_named_item_ambition_2 <- this.inherit("scripts/ambitions/ambition", {
	m = {
	...
	function create()
	{
		...
		this.m.ID = "ambition.el_named_item_2";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_named_item_1").isDone())
		{
			return;
		}
