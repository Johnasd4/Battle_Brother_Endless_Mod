this.el_melee_defense_entry <- this.inherit("scripts/skills/el_entrys/el_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_MeleeDefenseAddition <= this.Const.EL_Shield.EL_Entry.Factor.EL_MeleeDefense.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_MeleeDefenseAddition = this.Const.EL_Shield.EL_Entry.Factor.EL_MeleeDefense.BaseMeleeDefense + this.Math.rand(randomMin, randomMax);
	}
