this.commander_building <- this.inherit("scripts/entity/world/camp/camp_building", {
	...
	function getDescription()
	{
		...
		desc = desc + "\n\n";
		desc = desc + "Company starts out only knowing how to do repairs and rest. Visiting settlements that perfrom the analogous task will unlock it in the camp. All camp activities can be upgraded ";
