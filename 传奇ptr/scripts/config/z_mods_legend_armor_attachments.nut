...
gt.Const.LegendMod.ArmorObjs.extend([
	...
	{
		ID = "light_padding_replacement_upgrade",
	...
	{
		ID = "legend_stollwurm_scales_upgrade",
	...
	{
		ID = "legend_white_wolf_pelt_upgrade",
