...
gt.Const.World.Common.pickHelmet <- function ( _helms )
{
	...
	if (::Legends.Mod.ModSettings.getSetting("UnlayeredArmor").getValue())
	{
		...
		if (helm == "named/legend_helm_stag_named" || helm == "named/legend_helm_swan_named")
		{
			helm = "named/legend_helm_full_named";
		}
...
gt.Const.World.Common.pickArmor <- function ( _armors )
{
	...
	if (::Legends.Mod.ModSettings.getSetting("UnlayeredArmor").getValue())
	{
		if (armorID == "seedmaster_noble_armor" || armorID == "citreneking_noble_armor")
		{
