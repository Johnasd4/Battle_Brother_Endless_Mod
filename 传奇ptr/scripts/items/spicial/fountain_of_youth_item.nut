this.fountain_of_youth_item <- this.inherit("scripts/items/item", {
	...
	function onUse( _actor, _item = null )
	{
		...
		if(_actor.getSkills().hasSkill("trait.legend_prosthetic_ear"))
			_actor.getSkills().removeByID("trait.legend_prosthetic_ear");
		if(_actor.getSkills().hasSkill("trait.legend_prosthetic_eye"))
			_actor.getSkills().removeByID("trait.legend_prosthetic_eye");
		if(_actor.getSkills().hasSkill("trait.legend_prosthetic_finger"))
			_actor.getSkills().removeByID("trait.legend_prosthetic_finger");
		if(_actor.getSkills().hasSkill("trait.legend_prosthetic_foot"))
			_actor.getSkills().removeByID("trait.legend_prosthetic_foot");
		if(_actor.getSkills().hasSkill("trait.legend_prosthetic_forearm"))
			_actor.getSkills().removeByID("trait.legend_prosthetic_forearm");
		if(_actor.getSkills().hasSkill("trait.legend_prosthetic_leg"))
			_actor.getSkills().removeByID("trait.legend_prosthetic_leg");
		if(_actor.getSkills().hasSkill("trait.legend_prosthetic_hand"))
			_actor.getSkills().removeByID("trait.legend_prosthetic_hand");
		if(_actor.getSkills().hasSkill("trait.legend_prosthetic_nose"))
