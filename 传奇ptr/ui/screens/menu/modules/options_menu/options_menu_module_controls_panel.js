...
OptionsMenuModuleControlsPanel.prototype.createDIV = function (_parentDiv)
{
	...
	var tile = $('<div class="title title-font-big font-color-title">滚动模式</div>');
	row.append(tile);
	...
	var dragWithMouseCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-drag-with-mouse">鼠标拖动</label>');
	...
	var edgeOfScreenCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-edge-of-screen">边缘滚动</label>');
	...
	tile = $('<div class="title title-font-big font-color-title">鼠标</div>');
	row.append(tile);
	...
	var hardwareMouseCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-hardware-mouse">硬件光标</label>');
