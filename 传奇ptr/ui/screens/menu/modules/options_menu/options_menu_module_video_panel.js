...
OptionsMenuModuleVideoPanel.prototype.createDIV = function (_parentDiv)
{
	...
	var resolutionsTile = $('<div class="title title-font-big font-bold font-color-title">分辨率</div>');
	...
	var displayTile = $('<div class="title title-font-big font-bold font-color-title">显示</div>');
	...
	var fullscreenCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-fullscreen">全屏</label>');
	...
	var borderlessCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-window">窗口</label>');
	...
	borderlessCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-borderless">无边框窗口</label>');
	...
	var vsyncCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-vsync">垂直同步</label>');
	...
	var detailTile = $('<div class="title title-font-big font-bold font-color-title">细节</div>');
	...
	var depthOfFieldCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-depth-of-field">景深</label>');
	...
	var scalingTile = $('<div class="title title-font-big font-bold font-color-title">界面大小</div>');
	...
	var scalingRow = $('<div class="row"/>');
	rightColumn.append(scalingRow);
	var scalingTile = $('<div class="title title-font-big font-bold font-color-title">场景大小</div>');
	scalingRow.append(scalingTile);
	...
	var thanksLabel = $('<label class="text-font-normal font-color-brother-name">重新启动后更改生效！</label>');
