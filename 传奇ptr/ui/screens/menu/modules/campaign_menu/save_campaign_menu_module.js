...
SaveCampaignMenuModule.prototype.addNewSavegameEntryToList = function ()
{
    ...
    entry.assignListCampaignName(TranslateSaveCampaignMenuModule('New Savegame'));
...
SaveCampaignMenuModule.prototype.addCampaignEntryToList = function (_data)
{
	...
	{
    	entry.assignListCampaignDayName(TranslateSaveCampaignMenuModule("- Incompatible Version -"));
	...
	else
	{
		...
		{
    		entry.assignListCampaignDayName(TranslateSaveCampaignMenuModule(_data[CampaignMenuModulesIdentifier.Campaign.DayName]));
		}
	}

	if (CampaignMenuModulesIdentifier.Campaign.CreationDate in _data)
	{
        entry.assignListCampaignDateTime(TranslateSaveCampaignMenuModule(_data[CampaignMenuModulesIdentifier.Campaign.CreationDate]));
	}
...
SaveCampaignMenuModule.prototype.createDeleteDialogContent = function (_dialog, _name)
{
    ...
    var label = $('<div class="text-font-normal font-color-label">永久删除战役 <span class="text-font-normal font-color-label-warning">' + _name + '</span>?</div>');
	row.append(label);
