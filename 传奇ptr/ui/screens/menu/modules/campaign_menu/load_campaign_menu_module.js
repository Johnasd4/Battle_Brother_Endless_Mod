...
LoadCampaignMenuModule.prototype.addCampaignEntryToList = function (_data)
{
	...
	{
		entry.assignListCampaignDayName(TranslateLoadCampaignMenuModule("- Incompatible Version or DLC Missing -"));
	...
	else
	{
		...
		{
			entry.assignListCampaignDayName(TranslateLoadCampaignMenuModule(_data[CampaignMenuModulesIdentifier.Campaign.DayName]));
		}
	}

	if (CampaignMenuModulesIdentifier.Campaign.CreationDate in _data)
	{
        entry.assignListCampaignDateTime(TranslateLoadCampaignMenuModule(_data[CampaignMenuModulesIdentifier.Campaign.CreationDate]));
	}
