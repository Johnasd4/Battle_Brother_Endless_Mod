...
NewCampaignMenuModule.prototype.createDIV = function (_parentDiv)
{
	...
	contentContainer.append(this.mSecondPanel);
		...
		var title = $('<div class="title title-font-big font-color-title">战队名称</div>');
		row.append(title);
		...
		var row = $('<div class="row" />');
		leftColumn.append(row);
		var title = $('<div class="title title-font-big font-color-title">游戏后期危机</div>');
		row.append(title);
		...
		this.mEvilRandomLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-evil-random">随机</label>');
		...
		this.mEvilWarLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-evil-war">贵族战争</label>');
		...
		this.mEvilGreenskinsLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-evil-greenskins">绿皮入侵</label>');
		...
		this.mEvilUndeadLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-evil-undead">亡灵天灾</label>');
        ...
        this.mEvilCrusadeLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-evil-crusade">圣战</label>');
		...
		this.mEvilPermanentDestructionLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-extra-late">永久摧毁</label>');
	...
	contentContainer.append(this.mThirdPanel);
		...
		var row = $('<div class="row" />');
		leftColumn.append(row);
		var title = $('<div class="title title-font-big font-color-title">经济难度</div>');
		row.append(title);
		...
		this.mEconomicDifficultyEasyLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-economic-difficulty-easy">初学者</label>');
		...
		this.mEconomicDifficultyNormalLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-economic-difficulty-normal">老兵</label>');
		...
		this.mEconomicDifficultyHardLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-economic-difficulty-hard">专家</label>');
		...
		this.mEconomicDifficultyLegendaryLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-economic-difficulty-Legendary">传奇</label>');
		...
		var row = $('<div class="row" />');
		leftColumn.append(row);
		var title = $('<div class="title title-font-big font-color-title">启动资金</div>');
		row.append(title);
		...
		this.mBudgetDifficultyEasyLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-budget-difficulty-easy">高</label>');
		...
		this.mBudgetDifficultyNormalLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-budget-difficulty-normal">中</label>');
		...
		this.mBudgetDifficultyHardLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-budget-difficulty-hard">低</label>');
		...
		this.mBudgetDifficultyLegendaryLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-budget-difficulty-Legendary">无</label>');
		...
		var row = $('<div class="row" />');
		rightColumn.append(row);
		var title = $('<div class="title title-font-big font-color-title">战斗难度</div>');
		row.append(title);
		...
		this.mDifficultyEasyLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-difficulty-easy">初学者</label>');
		...
		this.mDifficultyNormalLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-difficulty-normal">老兵</label>');
		...
		this.mDifficultyHardLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-difficulty-hard">专家</label>');
		...
		this.mDifficultyLegendaryLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-difficulty-Legendary">传奇</label>');
		...
		var row = $('<div class="row" />');
		rightColumn.append(row);
		var title = $('<div class="title title-font-big font-color-title">铁人模式</div>');
		row.append(title);
		...
		this.mIronmanCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-iron-man">铁人模式</label>');
		...
		this.mExplorationCheckboxLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-exploration">未探索的地图</label>');
		...
		leftColumn.append(row);
		var title = $('<div class="title title-font-big font-color-title">地图种子</div>');
		row.append(title);
	...
	contentContainer.append(this.mFirstPanel);
		...
		var row = $('<div class="row" />');
		leftColumn.append(row);
		var title = $('<div class="title title-font-big font-color-title">战队起源</div>');
		row.append(title);
	...
	this.mStartButton = layout.createTextButton("Next", function ()
	{
		if(self.mFirstPanel.hasClass('display-block'))
		{
			...
			self.mCancelButton.changeButtonText("上一页");
		...
		else if(self.mSecondPanel.hasClass('display-block'))
		{
			...
			self.mStartButton.changeButtonText("开始");
		}
		else
		{
	...
	this.mCancelButton = layout.createTextButton("Cancel", function ()
	{
		...
		else if(self.mThirdPanel.hasClass('display-block'))
		{
			...
			self.mStartButton.changeButtonText("下一页");
			self.mCancelButton.changeButtonText("上一页");
		}
		else
		{
			...
			self.mSecondPanel.removeClass('display-block').addClass('display-none');
			self.mStartButton.changeButtonText("下一页");
			self.mCancelButton.changeButtonText("取消");
...
NewCampaignMenuModule.prototype.show = function ()
{
	...
	this.mStartButton.changeButtonText("下一页");
	this.mCancelButton.changeButtonText("取消");
...
NewCampaignMenuModule.prototype.addStartingScenario = function (_index, _data, _row)
{
	...
	var label = $('<label class="text-font-normal font-color-subtitle" for="cb-scenario-' + _index + '">' + TranslateNewCampaignMenuModule(_data.Name) + '</label>');
	...
	radioButton.on('ifChecked', null, this, function (_event)
	{
		...
		self.updateStartingScenarioDescription(TranslateNewCampaignMenuModule(_data.Description), _data.Difficulty);
	});

	if(_index == 0)
		this.updateStartingScenarioDescription(TranslateNewCampaignMenuModule(_data.Description), _data.Difficulty);
}
