...
ScenarioMenuModule.prototype.addScenarioEntryToList = function (_data)
{
	...
	var entry = $('<div class="list-entry list-entry-small"><span class="label text-font-normal font-color-label">' + TranslateScenarioMenuModule(_data[ScenarioMenuModuleIdentifier.Scenario.Name]) + '</span></div></div>');
...
ScenarioMenuModule.prototype.updateDescription = function (_data)
{
	if (_data !== null && ScenarioMenuModuleIdentifier.Scenario.Description in _data && typeof(_data[ScenarioMenuModuleIdentifier.Scenario.Description]) == 'string')
	{
		...
		{
			text: TranslateScenarioMenuModule(_data[ScenarioMenuModuleIdentifier.Scenario.Description]),
