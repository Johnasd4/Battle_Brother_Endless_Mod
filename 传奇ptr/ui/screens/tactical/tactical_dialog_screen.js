...
{
    this.mDialogContainer.findDialogTitle().html(TranslateDialog(_data.Title));

    this.mYesButton.changeButtonText(TranslateButton(_data.YesButtonLabel));
    this.mNoButton.changeButtonText(TranslateButton(_data.NoButtonLabel));
    ...
    var fleeTitleLabel = $('<div class="dialog-title-label title-font-normal font-bold font-color-title">' + TranslateDialog(_data.Subtitle) + '</div>');
	rightColumn.append(fleeTitleLabel);

    var fleeTextLabel = $('<div class="dialog-text text-font-medium font-color-description font-style-normal">' + TranslateDialog(_data.Text) + '</div>');
