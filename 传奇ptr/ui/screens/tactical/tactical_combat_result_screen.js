...
TacticalCombatResultScreen.prototype.createDIV = function (_parentDiv)
{
	...
	{
        self.mLeaveButton.changeButtonText("继续");
	...
	{
        self.mLeaveButton.changeButtonText("离开");
...
TacticalCombatResultScreen.prototype.onCombatInformation = function (_dataSource, _data)
{
		...
		_data[TacticalCombatResultScreenIdentifier.CombatInformation.Result.Key] !== null)
	{
		...
		if(!enableLootButton)
			this.mLeaveButton.changeButtonText("离开");
	}
	...
	{
        this.mDialogContainer.findDialogTitle().html(TranslateDialog(_data[TacticalCombatResultScreenIdentifier.CombatInformation.Title]));
	}
	...
	{
        this.mDialogContainer.findDialogSubTitle().html(TranslateDialog(_data[TacticalCombatResultScreenIdentifier.CombatInformation.SubTitle]));
	}
};
