...
WorldScreenActiveContractPanelModule.prototype.loadFromData = function (_data)
{
	...
	{
        this.mTitleContainer.html(TranslateWorldScreenActiveContractPanelModule0(_data.Title));
	}
...
//	 description.html('<br/>');
	...
	if('title' in _data && _data.title !== null)
	{
		...
		var parsedTitleText = XBBCODE.process({
            text: TranslateWorldScreenActiveContractPanelModule1(_data.title),
...
//	 }
	...
	if ('text' in _item && _item.text !== null)
	{
		...
		var parsedText = XBBCODE.process({
            text: TranslateWorldScreenActiveContractPanelModule2(_item.text),
			removeMisalignedTags: false,
			addInLineBreaks: true
		});
