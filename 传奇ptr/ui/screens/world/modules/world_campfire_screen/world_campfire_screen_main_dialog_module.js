...
WorldCampfireScreenMainDialogModule.prototype.loadFromData = function (_data)
{
	...
	{
        this.mDialogContainer.findDialogTitle().html(TranslateWorldCampfireScreenMainDialogModule(_data['Title']));
	}

	if('SubTitle' in _data && _data['SubTitle'] !== null)
	{
        this.mDialogContainer.findDialogSubTitle().html(TranslateWorldCampfireScreenMainDialogModule(_data['SubTitle']));
	}
