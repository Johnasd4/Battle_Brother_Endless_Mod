...
WorldTownScreenTrainingDialogModule.prototype.createDIV = function (_parentDiv)
{
    ...
    this.mNoInjuredLabel = $('<div class="is-no-wounded-hint text-font-medium font-bottom-shadow font-color-description display-none">你的队伍中没有人可以在这里训练。</div>');
    ...
    var explanation = $('<div class="text-font-medium font-bottom-shadow font-color-description is-explanation">租用训练场地并支付课程费，把你的人塑造成有经验的战士。</div>');
...
WorldTownScreenTrainingDialogModule.prototype.updateDetailsPanel = function(_element)
{
    if(_element !== null && _element.length > 0)
    {
        ...
        {
        	var row = $('<div class="is-injury-row display-block text-font-medium font-bottom-shadow font-color-description display-none">目前没有可用的训练选项。</div>');
...
WorldTownScreenTrainingDialogModule.prototype.createTrainingControlDIV = function (_i, _parentDiv, _entityID, _data, _money)
{
	...
	var name = $('<div class="is-name text-font-normal font-bottom-shadow font-color-description">' + TranslateWorldTownScreenTrainingDialogModule(_data.name) + '</div>');
...
WorldTownScreenTrainingDialogModule.prototype.loadFromData = function (_data)
{
	...
	{
		 this.mDialogContainer.findDialogTitle().html(TranslateWorldTownScreenTrainingDialogModule(_data.Title));
	}

	if('SubTitle' in _data && _data.SubTitle !== null)
	{
		 this.mDialogContainer.findDialogSubTitle().html(TranslateWorldTownScreenTrainingDialogModule(_data.SubTitle));
	}
