...
WorldTownScreenTempleDialogModule.prototype.createDIV = function (_parentDiv)
{
    ...
    this.mNoInjuredLabel = $('<div class="is-no-wounded-hint text-font-medium font-bottom-shadow font-color-description display-none">你的队伍里没有受伤的人，不需要在这里接受治疗。</div>');
    ...
    var explanation = $('<div class="text-font-medium font-bottom-shadow font-color-description is-explanation">对伤口进行治疗，使伤口愈合更快，在路上不会恶化。</div>');
...
WorldTownScreenTempleDialogModule.prototype.loadFromData = function (_data)
{
	...
	{
		 this.mDialogContainer.findDialogTitle().html(TranslateWorldTownScreenTempleDialogModule(_data.Title));
	}

	if('SubTitle' in _data && _data.SubTitle !== null)
	{
		 this.mDialogContainer.findDialogSubTitle().html(TranslateWorldTownScreenTempleDialogModule(_data.SubTitle));
	}
