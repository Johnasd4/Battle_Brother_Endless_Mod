...
WorldTownScreenBarberDialogModule.prototype.createDIV = function (_parentDiv)
{
	...
	this.createAppearanceControlDIV(TranslateWorldTownScreenBarberDialogModule("Hair Color"), 'color-control', this.mAppearanceOptions.Color, row);

	var row = $('<div class="row"></div>');
	this.mDetailsPanel.Container.append(row);
	this.createAppearanceControlDIV(TranslateWorldTownScreenBarberDialogModule("Head"), 'Head-control', this.mAppearanceOptions.Head, row);

	var row = $('<div class="row"></div>');
	this.mDetailsPanel.Container.append(row);
	this.createAppearanceControlDIV(TranslateWorldTownScreenBarberDialogModule("Hair"), 'hair-control', this.mAppearanceOptions.Hair, row);

	var row = $('<div class="row"></div>');
	this.mDetailsPanel.Container.append(row);
	this.createAppearanceControlDIV(TranslateWorldTownScreenBarberDialogModule("Beard"), 'beard-control', this.mAppearanceOptions.Beard, row);

	var row = $('<div class="row"></div>');
	this.mDetailsPanel.Container.append(row);
	this.createAppearanceControlDIV(TranslateWorldTownScreenBarberDialogModule("Body"), 'body-control', this.mAppearanceOptions.Body, row);

	var row = $('<div class="row"></div>');
	this.mDetailsPanel.Container.append(row);
	this.createAppearanceControlDIV(TranslateWorldTownScreenBarberDialogModule("Tattoo"), 'tattoo-control', this.mAppearanceOptions.Tattoo, row);
...
WorldTownScreenBarberDialogModule.prototype.loadFromData = function (_data)
{
	...
	{
		 this.mDialogContainer.findDialogTitle().html(TranslateWorldTownScreenBarberDialogModule(_data.Title));
	}

	if('SubTitle' in _data && _data.SubTitle !== null)
	{
		 this.mDialogContainer.findDialogSubTitle().html(TranslateWorldTownScreenBarberDialogModule(_data.SubTitle));
	}
