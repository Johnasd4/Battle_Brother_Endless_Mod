...
CampScreenRepairDialogModule.prototype.createDIV = function (_parentDiv)
{
    ...
    var headerRow = $('<div class="row is-header title-font-normal font-bold font-color-title">仓库</div>');
    ...
    headerRow = $('<div class="row is-header title-font-normal font-bold font-color-title">修理</div>');
