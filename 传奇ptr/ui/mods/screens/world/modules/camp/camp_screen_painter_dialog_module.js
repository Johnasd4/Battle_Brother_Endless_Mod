...
CampScreenPainterDialogModule.prototype.createDIV = function (_parentDiv)
{
    ...
    var headertext = $('<div class="armorname title-font-normal font-bold font-color-brother-name">盔甲</div>');
	backgroundRow.append(headertext);
 	headertext = $('<div class="helmetname title-font-normal font-bold font-color-brother-name">头盔</div>');
	backgroundRow.append(headertext); 
	...
	this.mDetailsPanel.Container.append(detailsRow);
    var costsLabel = $('<div class="totalmoney title-font-normal font-bold font-bottom-shadow font-color-title">总花费:</div>');
