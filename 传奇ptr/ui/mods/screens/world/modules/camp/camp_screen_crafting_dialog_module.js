...
CampScreenCraftingDialogModule.prototype.createDIV = function (_parentDiv)
{
    ...
    this.mNoCraftablesLabel = $('<div class="is-no-craftables-hint text-font-medium font-bottom-shadow font-color-description display-none">你的战利品组合无法制作任何东西。</div>');
    ...
    var queueHeaderLabel = $('<div class="label title-font-normal font-bold font-bottom-shadow font-color-title">制作队列</div>');
    ...
    var ingredientsHeaderLabel = $('<div class="label title-font-normal font-bold font-bottom-shadow font-color-title">所需材料</div>');
...
CampScreenCraftingDialogModule.prototype.loadFromData = function (_data)
{
	...
	{
		 this.mDialogContainer.findDialogTitle().html(TranslateWorldScreenCampDialogModule(_data.Title));
	}

	if('SubTitle' in _data && _data.SubTitle !== null)
	{
		 this.mDialogContainer.findDialogSubTitle().html(TranslateWorldScreenCampDialogModule(_data.SubTitle));
	}
