...
CampScreenHealerDialogModule.prototype.createDIV = function (_parentDiv)
{
    ...
    this.mNoInjuredLabel = $('<div class="is-no-wounded-hint text-font-medium font-bottom-shadow font-color-description display-none">没有人被分配到这个帐篷里。</div>');
    ...
    var queueHeaderLabel = $('<div class="label title-font-normal font-bold font-bottom-shadow font-color-title">治疗队列</div>');
    ...
    var injuriesHeaderLabel = $('<div class="label title-font-normal font-bold font-bottom-shadow font-color-title">伤病列表</div>');
...
CampScreenHealerDialogModule.prototype.createInjuryControlDIV = function (_i, _parentDiv, _entityID, _data, _money)
{
	...
	var name = $('<div class="is-name text-font-normal font-bottom-shadow font-color-description">' + TranslateToolTip0_SunShang(_data.name) + '</div>');
	row.append(name);
