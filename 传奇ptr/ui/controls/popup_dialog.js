...
$.fn.createPopupDialog = function(_title, _subTitle, _headerImagePath, _classes, _modalBackground)
{
	...
	{
        var title = $('<div class="title title-font-very-big font-bold font-bottom-shadow font-color-title">' + TranslatePopupDialog(_title) + '</div>');
	...
	if (_subTitle !== undefined && _subTitle !== null && typeof(_subTitle) === 'string')
	{
        ...
        var subTitle = $('<div class="sub-title text-font-normal font-style-italic font-bottom-shadow font-color-subtitle">' + TranslatePopupDialog(_subTitle) + '</div>');
