 ...
 */
 $.fn.createDialog = function(_title, _subTitle, _headerImagePath, _withTabs, _classes)
 {
	...
	{
        var title = $('<div class="title has-no-sub-title title-font-very-big font-bold font-bottom-shadow font-color-title">' + TranslateDialog(_title) + '</div>');
	...
	if (_subTitle !== undefined && _subTitle !== null && typeof(_subTitle) === 'string')
	{
        ...
        var subTitle = $('<div class="sub-title text-font-normal font-style-italic font-bottom-shadow font-color-subtitle">' + TranslateDialog(_subTitle) + '</div>');
