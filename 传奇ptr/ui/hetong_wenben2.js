var TranslateHeTong_WenBen2 = function(text)
{
//patrol_contract.nut
	...
	text = text.replace(/Before those arseholes can get into formation, you order the (.*?) to charge!/, "你随即对 $1 下令，趁这帮老屁眼们还没摆好阵形前对他们冲锋！");
	...
	text = text.replace(/Reaching (.*?), (.*?) suggests that the company should pick up some supplies for the journey back to (.*?)\. You\'ve already thought of this, but you give the sellsword the satisfaction of having come up with the idea himself\./, "到达了 $1，$2向你提议是否需要在回到 $3 之前，在这里多买一些物资。其实你老早就想到这一点了，只不过你还是夸了一下这位兄弟想出来的好点子，来满足他干活的积极性。");
	...
	text = text.replace(/Your emphasis is on the kills, as that is what you\'re being paid for\. (.*?) nods and has one of his men throw crowns into a satchel and hand it over\./, "并且你特别着重讲到了关于砍杀方面的事情，毕竟这一部分是你得到酬劳多少的主体因素。$1 点了点头，让他的手下把说好的克朗塞进一个钱包里，并最终给你递了过来。");
	...
	text = text.replace("The nobleman chuckles.", "贵族笑了。");
	...
	text = text.replace("A man appears from the side with a satchel in hand.", "他的一个手下从旁边走了过来，手里拿着一个提包。");
	...
	text = text.replace(/Shrugging, (.*?) turns and leaves, slipping into the crowd of attendees\./, "$1 耸了耸肩，转身离开了，慢慢地溜进宴会的人群中去。");
	text = text.replace("You try to chase, but a man cuts you off, slamming a satchel into your chest.", "当你尝试想去追他讨要报酬的时候，突然一个人挡住了你的去路，把一包钱袋猛地一下子推进你的胸上。");
	...
	text = text.replace("You don\'t move. The man purses his lips and shrugs.", "你没有做任何反应。那人抿了抿嘴，然后耸了耸肩。");
	text = text.replace("Ah hell, well...", "啊，见鬼，好吧…");
	text = text.replace("He looks at you and almost gags on a chuckle.", "他看着你，笑得几乎要吐了。");
	...
	text = text.replace(/Shrugging, you explain that there was no trouble on the patrol\. (.*?)\'s taking a sip of wine and almost chokes on it at this news\./, "耸了耸肩，你解释道巡逻的路上一路平安，没有任何情况发生。$1 一边喝着酒一边听到你说的消息，差点噎住了。");
...
//privateering_contract.nut
	...
	text = text.replace("You nod. The man continues.", "你点头。他继续说道。");
	...
	text = text.replace("You shrug and guess that his grandfather used subterfuge of some sort.", "你耸肩，猜或许他的祖父用了某种诡计。");
	...
	text = text.replace("You nod. Who hasn\'t? The man continues.", "你点头。谁没有呢？他继续说道。");
	...
	text = text.replace("You ask who told him that. The boy shrugs.", "你问他谁说的。他耸肩。");
	...
	text = text.replace("Which noble house is treating the company better?", "哪一边的贵族对战队更好？");
	...
	text = text.replace(/He hands over a satchel of (.*?) crowns\./, "他递了一个包，里面有 $1 克朗。");
	...
	text = text.replace(/Excellent! Outstanding! Perfection! That is what I have to say about your work, sellsword\. Hell, we even got a few deserters from (.*?)\'s armies who are very worried their side has already lost!/, "干得好！太棒了！完美！这是我得对你的表现说的，佣兵。天啊，我们甚至抓到了几个从 $1的军队里跑来的逃兵，他们很担心他们那一边已经输了！");
...
//raid_caravan_contract.nut
	...
	text = text.replace("You shrug as if to say, \'easily done.\'", "你耸肩好像在说，“轻轻松松。”");
	...
	text = text.replace("Do you understand? Let\'s talk numbers if you do.", "你理解了吗？理解了就让我们谈谈数字。");
	...
	text = text.replace("Understand? If you do, let\'s talk numbers.", "明白了吗？如果你懂了，让我们谈谈数字。");
	...
	text = text.replace("You wonder aloud why you would take the bribe when you could kill them all and take it anyway. The man shrugs.", "你大声寻思为什么不在杀了他们之后拿走这些钱。他耸肩。");
	...
	text = text.replace("As you begin to leave, the caravan leader grabs you by the arm.", "随着你开始离开，商队领头抓住了你的手臂。");
	text = text.replace("Hey, I\'m curious about something, and I bet you got something to scratch that curiosity.", "嗨，我很好奇一些事情，而且我打赌你一定有什么东西可以满足我的好奇心。");
	...
	text = text.replace("The caravan leader catches you before you can depart.", "商队领头在你可以离开前抓住你。");
	...
	text = text.replace("The caravan leader nods solemnly.", "商队首领郑重地点头。");
	...
	text = text.replace(/While preparing to assault the caravan, (.*?) comes to your side and points to one of the men in the wagontrain\./, "在准备袭击商队时，$1 来到你身旁并指向其中一个坐在车上的人。");
	...
	text = text.replace("Having won the battle, your men spread out to collect the goods and make sure every caravan guard is good and dead.", "赢得了胜利，你的手下散开来收集战利品并确保每个护卫都死了。");
	...
	text = text.replace("As the horrific shrieks fill the air, you get the sense that some mercenaries are hacking and slashing simply to drive the noise out of their heads.", "随着恐怖的哭号，你感到有些的佣兵挥舞着武器只是为了让这可怖的声音离开他们的脑海。");
	...
	text = text.replace(/It appears (.*?) had a very, very ulterior motive for attacking this particular wagon train\./, "看起来 $1 又一个非常，非常不可告人的动机来特别攻击这个商队。");
	...
	text = text.replace("A few guard stand a ways off, and you imagine one of the handful of peasants lingering is really just a guard in disguise.", "几个守卫在不远处站岗，并且你怀疑逗留在场的其中一个平民也是便衣警卫。");
	...
	text = text.replace("Excellent! Most excellent, sellsword!", "棒！太棒了，佣兵！");
	text = text.replace("You\'ve no idea what your work has done for me today.", "你不知道你帮了我多大一个忙。");
	text = text.replace("Of course, your payment, as promised...", "当然，你的报酬，我们谈好的…");
	...
	text = text.replace("He pauses, then shrugs.", "他停下来，然后耸肩。");
	text = text.replace("Alright, I\'ll give you half of what we agreed to.", "好吧，我会给你一半的报酬。");
	text = text.replace("You did destroy the wagon train, after all, I\'ll give you that.", "毕竟，你还是摧毁了商队，我得承认。");
	...
	text = text.replace("He shrugs and throws you a satchel.", "他耸肩给你一个袋子。");
	...
	text = text.replace("You shrug. The man continues.", "你耸肩，他继续说道。");
...
//raze_attached_location_contract.nut
	...
	text = text.replace(/I want you to burn the (.*?) close to (.*?) to the ground and kill the peasantry there\./, "我想要你烧了 $1 那里在 $2 附近，还有杀几个平民。");
	...
	text = text.replace(/You pass through some tall weeds to get a good look at (.*?)\. There are a few peasants walking about, completely oblivious to the cat-like destruction stalking through the grass just outside their little hamlet\./, "你穿过些高草好观察 $1。几个平民在散步，完全不知毁灭像猫一样藏在他们小村庄外的草里。");
	...
	text = text.replace("How ironic that these peasants would have been safer as mongrels than humans.", "真讽刺，这些平民可能还没狗安全。");
	...
	text = text.replace(/Evening, mercenaries\. (.*?) sends his regards\./, "晚上好，佣兵们。$1 送出他的致敬。");
	...
	text = text.replace("You shrug and ask why you\'ve been setup.", "你耸肩问道为什么你被算计了。");
	...
	text = text.replace("You unsheathe your sword and flash its blade at the lieutenant.", "你拔剑闪向军官。");
	...
	text = text.replace("Maybe next time, when I agree to do something for these people, I actually do it.", "下次吧，当你同意为这些人做点 什么，实际完成它。");
	...
	text = text.replace(/(.*?), judging by the dead bannermen at your feet, appears to no longer be happy with you\./, "$1，从你脚下的旗手尸体判断，看来不再喜欢你了。");
	...
	text = text.replace("Here is your payment as promised, sellsword.", "这是你说好的报酬，佣兵。");
...
//restore_location_contract.nut
	...
	text = text.replace("The cemetery\'s markings are tilted and some flat on the ground.", "墓园的标记弯曲了还有些倒在地上。");
	...
	text = text.replace("Luckily it is without bloodshed, but every refugee that passes before your gaze meets it with a solemn, sad look. You shrug.", "幸运的是没有冲突，但是每个经过的难民跟你对视时都带着一股沉重，悲伤的表情。你耸肩。");
	...
	text = text.replace("A bag of crowns is thanks enough.", "一袋克朗足够谢意了。");
	...
	text = text.replace(/One of his men hands you a burlap sack heavy and sharpened by crowns\. (.*?) tips a hand\./, "其中一个手下递给你粗麻布装的沉重克朗。$1 做了个手势。");
	text = text.replace("Be seeing you, sellsword.", "后会有期，佣兵。");
	text = text.replace(/(.*?) is in his study when you return./, "$1 在你回来时正在读书。");
	text = text.replace("He shows a scroll to you and asks if you know what it is. You shrug.", "他给你看了个卷轴问你知不知道这是什么。你耸肩。");
...
//text = text.replace("You shrug.", "你耸肩。");
	...
	text = text.replace("Sheathing your sword, you nod at the man. He continues.", "收起剑，你点头。他继续说道。");
	...
	text = text.replace(/You hand over the (.*?) and the stranger slips you a very heavy, very drooping satchel\./, "你把 $1 交出去然后陌生人递给你一个非常沉重的包裹。");
	...
	text = text.replace("Excellent. And for your troubles...", "很好。然后为了弥补你的麻烦…");
	...
	text = text.replace("When his hand returns, he\'s got a satchel in hand.", "当他手回来，他手里有一个包裹。");
	...
	text = text.replace(/Very good. (.*?) crowns, as promised\./, "非常好。$1 克朗，我们谈好的。");
...
//roaming_beasts_contract.nut
	text = text.replace(/While you wait for (.*?) to explain what he needs your services for, you contemplate on how silent and eerie the whole settlement was when you first arrived\. (.*?) raises his voice/, "在你等待 $1 解释他的需求时，你寻思进来的路上这个镇子为什么格外的安静。$2 提起嗓门");
	...
	text = text.replace("You shake your head. The man continues.", "你摇头。他继续说道。");
	text = text.replace(/A week ago we sent the famed (.*?) of here to go hunt down some foul beasts that have been terrorizing the town and surrounding farmsteads for weeks\./, "一个星期前我们派有名的 $1 离这里猎杀一些近几个星期都在这一代制造恐怖的野兽。");
	...
	text = text.replace("When you question what he\'s talking about, he throws his hands up, thrusting his hips at you.", "当你问他在说什么，他抬起手，腰间向你突过来。");
	text = text.replace("He turns afoot like a puppet spun about and takes off running, hooting and hollering.", "他转身像小狗一样逃跑，又喊又叫的。");
	...
	text = text.replace(/He\'s got the ugly mug on him and he\'ll be carrying the (.*?) crowns, as promised\./, "他有张丑脸而且他带着 $1 克朗，我们说好的。");
	...
	text = text.replace("You shrug and toss it onto his table.", "你耸肩把它丢到他桌上。");
	...
	text = text.replace("You shrug. He shrugs, too.", "你耸肩。他也耸肩。");
	...
	text = text.replace(/Good work, sellsword\. (.*?) crowns, as promised\./, "干得好，佣兵。$1 克朗，谈好的。");
...
//roaming_beasts_desert_contract.nut
	...
	text = text.replace("He points to another area of the map which just looks like a bunch of empty desert. He continues.", "他指向地图上另一个区域，看起来只像一片空旷的沙漠。他继续说道。");
	...
	text = text.replace("He points around the scene and shrugs.", "他指向周围耸了耸肩。");
	...
	text = text.replace("Pausing briefly because you\'re not sure if the crowd can take it, you shrug and then spill out the nachzehrers\' remains.", "短暂停驻了一下，因为你不太确定人们是否会接受，你耸肩后甩了食尸鬼们的残骸出来。");
	...
	text = text.replace(/All (.*?) crowns are handed to you as promised, then you are quietly urged to leave the room\./, "全部 $1 克朗如同说好的一样交给了你，然后你在悄悄的催促下离开了房间。");
	...
	text = text.replace(/Satisfied, he hands you a purse of (.*?) crowns\./, "很满意，他交给你一袋子 $1 克朗。");
...
//root_out_undead_contract.nut
	...
	text = text.replace("And by find out I mean kill them all if it\'s true and come back to me with the good news.", "然后我说的看看是指杀光它们，如果确实如此，并带着好消息回来找我。");
	...
	text = text.replace("You ask what the hell he\'s still doing around then. He shrugs.", "你问他在这种地方做什么。他耸肩。");
	...
	text = text.replace("Taking up a scope you see, running along the horizon like ants scuttling atop their mound, are a couple of grey-garbed men with a haze of disease lingering behind them.", "拿起镜子你看到，在地平线上像蚂蚁在它们的土丘上忙碌一样，几个灰衣人后带着一层疫病般的薄雾。");
	...
	text = text.replace(/(.*?) reports that a couple of odd men have been spotted running away from the (.*?)\. You shrug and tell him it\'s quite normal to flee from a mercenary band\./, "$1 报告有几个奇怪的人被看到正逃离 $2。你耸肩并告诉他逃离一个雇佣兵团是很正常的。");
	...
	text = text.replace(/You look down at a necromancer\'s gaunt, ghoulish face\. (.*?) comes up and spits, landing a hefty goober right on the corpse\'s cheek\./, "你低头看着死灵法师消瘦，病态的脸。$1 走过来吐了口唾沫，花生一样径直的落在尸体的脸颊上。");
	...
	text = text.replace(/The necromancers have been slain, though the light in their eyes is disturbingly slow to depart\. (.*?) still seems rather proud about the battle\./, "死灵法师们被杀掉了，尽管它们眼里的光令人的不安的久久没有消散。$1 仍然看起来对于这场战斗很骄傲。");
	...
	text = text.replace("You tell him that his band of idiot men would have blundered to their doom had you not shown up. He shrugs.", "你告诉他，他的这队蠢货如果不是你没出现就是在自投死路。他耸肩。");
	...
	text = text.replace(/(.*?) waves you into his room with one and with the other holds out a bag of crowns\./, "$1 一只手招你进房间而用另一只手提着一袋克朗。");
	...
	text = text.replace(/Your pay is (.*?) crowns, as promised, or you can take the puppy\./, "你的报酬是 $1 克朗，我们说好的，或者你可以带走这只小狗。");
	...
	text = text.replace(/Here, (.*?) crowns, as promised\./, "这儿，$1 克朗，说好的一样。");
...
//siege_fortification_contract.nut
	text = text.replace(/(.*?) welcomes you into his room\./, "$1 欢迎你来到他的房间。");
	...
	text = text.replace("Hey, good job out there, sellsword.", "嗨，做得很好，佣兵。");
	...
	text = text.replace("Hey, you did a good job, sellsword.", "嗨，你做得很好，佣兵。");
	...
	text = text.replace("Probably stable hands, squires. What a shame.", "可能是马厩的帮手，扈从。太可惜了。");
	...
	text = text.replace("Hey, you hungry?", "嗨，你饿了吗？");
	...
	text = text.replace("Capturing this passageway would be an enormous tactical advantage in the days to come.", "占领这条密道将会为来日的围攻赢得巨大的战术优势。");
	...
	text = text.replace("You clean your blade and shrug.", "你擦了擦你的刀刃并耸了耸肩。");
	...
	text = text.replace(/Black birds do stare down from the walls, joining you in the conquest and just waiting for an opportunity to plunder\. (.*?) claps you on the shoulder and thanks you for the help\./, "黑色的鸟从城墙上向下凝视着，准备加入进你的征讨，等待时机劫掠猎物。$1 拍着你的肩膀感谢你的帮助。");
	...
	text = text.replace("You ask what he\'s going to do with the prisoners. He shrugs.", "你问他想要拿这些战俘怎么办。他耸肩。");
	...
	text = text.replace("The siege camp roars with anticipation.", "好的。");
	...
	text = text.replace("They\'re bringing volume and you\'ll be bringing violence. To battle!", "他们用歌声向你们逼近，你们将以武力奉还。战斗吧！");
	...
	text = text.replace(/You shrug and turn to the (.*?)\./, "你耸肩转向 $1。");
	...
	text = text.replace(/The man snaps his fingers and a servant hands you a satchel of (.*?) crowns\./, "这个男人打了一个响指，一名仆人递给你了一个装着 $1 克朗的小背包。");
	...
	text = text.replace(/The nobleman personally gives you a satchel of (.*?) crowns\./, "这名贵族亲自给你一个装着 $1 克朗的小背包。");
	...
	text = text.replace(/I\'ve been requested to meet you here with this satchel of (.*?) crowns\./, "我奉命在这里见你，带给你这个装着 $1 克朗的小背包。");
	text = text.replace("You take the satchel and nod.", "你拿了小背包并点头。");
	...
	text = text.replace("Nobles only.", "只许贵族进入。");
	text = text.replace("Just as you are about to start an argument, a servant steps out of the room with a large satchel.", "正当你准备开始争吵，一名仆人从屋里踏了出来，带着一个大背包。");
	text = text.replace(/He sees the sigil of the (.*?) and hands you a satchel\./, "他看到 $1 的徽章，把背包递给你。");
	...
	text = text.replace("He\'s got a servant with him that\'s carrying a large satchel. The commander speaks.", "他带着一名仆人，仆人身上挎着一个大背包。这名指挥官说道。");
	...
	text = text.replace(/The large satchel of (.*?) crowns is placed in your hands\./, "一大背包的 $1 克朗递到了你的手上。");
...
//slave_uprising_contract.nut
	text = text.replace(/Normally surrounded by contemplative opulence, (.*?) is in a whirlwind of advisers and fellow Viziers, each counseling the other with snaps of their fingers and aggressive points on a map\./, "$1 通常在深思熟虑，在由顾问和维齐尔大臣们组成的漩涡中思考，这里的每个人都用手指的啪啪声和地图上咄咄逼人的点来互相咨询。");
	...
	text = text.replace(/The Viziers of (.*?) are together in their war room and there is more tension than usual in the air\./, "$1 的维齐尔大臣们待在他们的作战室里，气氛比平时更加紧张。");
	...
	text = text.replace(/In death, the faces of the slaves do seem to carry some relief, as though the end of all things is preferred to the relentless cruelty of living in the chain\. (.*?) and the Viziers will be awaiting your return\./, "在死亡中，奴隶们的脸看起来确实有些宽慰，似乎所有事情的结局都比生活在锁链中的残酷无情要好。$1 和维齐尔大臣将等待你的返回。");
	...
	text = text.replace("I\'ve work that needs finishing and sometimes the Viziers lend me a few.", "我也有我的工作需要完成，有时候维齐尔大臣会借给我一些东西。");
	...
	text = text.replace("He hands you a purse of coins.", "他递给你一袋硬币。");
	text = text.replace("You look up to see the Vizier set the cage down and walk away.", "你抬头一看，维齐尔大臣放下笼子，走开了。");
	...
	text = text.replace("The Vizier disappears momentarily, then reemerges between a woman\'s thighs.", "维齐尔大臣瞬间消失，然后又出现在一个女人的大腿之间。");
...
//tutorial_contract.nut
	...
	text = text.replace(/The man who hired the company days ago, (.*?), no doubt expected you to return in a more glorious fashion\./, "几天前雇用战队的那个人，$1，无疑希望你能以一种更光荣的方式回来。");
	...
	text = text.replace(/As you leave (.*?)\'s house and stand on the outskirts of (.*?), (.*?) seeks a word with you\./, "当你离开 $1的住宅，站在 $2 的郊外，$3 找你说话。");
	...
	text = text.replace("He speaks as though he\'s identifying a disease he is about to excise.", "他讲话的口气像是要检查病症一样。");
	...
	text = text.replace(/You carry his head in a sack that you empty in front of (.*?)\'s feet\./, "你把他的头从 $1 脚前的麻袋里拿出来。");
