this.el_battle_standard_ambition_rank_1 <- this.inherit("scripts/ambitions/ambition", {
	m = {},
	function create()
	{
		this.ambition.create();
		this.m.ID = "ambition.el_battle_standard_ambition_rank_1";
		this.m.Duration = 99999.0 * this.World.getTime().SecondsPerDay;
		this.m.ButtonText = "Our battle standard needs an upgrade, so we shall gather 10,000 crowns for this.";
		...
		this.m.TooltipText = "Gather the amount of 10,000 crowns or more, so that you can upgrade your battle standard. You can make money by completing contracts, looting camps and ruins, or trading.";
	...
	{
		if (this.World.Assets.getMoney() >= 10000 && this.World.Assets.getStash().hasEmptySlot())
		{
			return true;
		}
		return false;
