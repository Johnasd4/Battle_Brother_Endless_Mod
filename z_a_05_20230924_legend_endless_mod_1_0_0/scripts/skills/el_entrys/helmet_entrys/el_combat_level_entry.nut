this.el_combat_level_entry <- this.inherit("scripts/skills/el_entrys/el_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_CombatLevelAddition <= this.Const.EL_Helmet.EL_Entry.Factor.EL_CombatLevel.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_CombatLevelAddition = this.Const.EL_Helmet.EL_Entry.Factor.EL_CombatLevel.BaseCombatLevel + this.Math.rand(randomMin, randomMax) * 0.01;
	}
