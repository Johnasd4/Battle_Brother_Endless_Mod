this.el_ranged_defense_entry <- this.inherit("scripts/skills/el_entrys/el_entry", {
	...
	function EL_getEntryColour()
	{
        ...
        {
            if (this.m.EL_RangedDefenseAddition <= this.Const.EL_Helmet.EL_Entry.Factor.EL_RangedDefense.ColourRange[index])
            {
	...
	function EL_createAddition()
	{
		...
		this.m.EL_RangedDefenseAddition = this.Const.EL_Helmet.EL_Entry.Factor.EL_RangedDefense.BaseRangedDefense + this.Math.rand(randomMin, randomMax);
	}
