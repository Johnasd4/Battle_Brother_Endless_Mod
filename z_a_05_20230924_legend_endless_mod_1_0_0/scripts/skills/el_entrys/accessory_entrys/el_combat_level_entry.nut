this.el_combat_level_entry <- this.inherit("scripts/skills/el_entrys/accessory_entrys/el_accessory_entry", {
	...
	function getTooltip( _id )
	{
		...
		local result = {
			id = _id,
			type = "text",
			text = "[color=" + colour + "]CombatLevel + " + this.m.EL_CurrentLevel * this.m.EL_CombatLevelAddition + "[/color]"
		};
		return result;
	}
	...
	{
		_EL_totalEntry.m.EL_CombatLevelAddition += this.m.EL_CurrentLevel * this.m.EL_CombatLevelAddition;
	}
