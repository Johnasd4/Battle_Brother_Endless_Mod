this.el_test_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function onAddEquipment()
	{
		...
		// stash.add(this.new("scripts/items/accessory/special/legend_oms_fate_item"));
		// stash.add(this.new("scripts/items/accessory/special/legend_oms_ledger_item"));
		// stash.add(this.new("scripts/items/accessory/special/legend_oms_paw_item"));
		// stash.add(this.new("scripts/items/accessory/special/legend_oms_rib_item"));
		stash.add(this.new("scripts/items/accessory/alp_trophy_item"));
		// stash.add(this.new("scripts/items/accessory/ghoul_trophy_item"));
		// stash.add(this.new("scripts/items/accessory/goblin_trophy_item"));
		// stash.add(this.new("scripts/items/accessory/hexen_trophy_item"));
		// stash.add(this.new("scripts/items/accessory/legend_demon_banshee_trophy_item"));
		// stash.add(this.new("scripts/items/accessory/legend_demonalp_trophy_item"));
		// stash.add(this.new("scripts/items/accessory/legend_hexen_leader_trophy_item"));
		// stash.add(this.new("scripts/items/accessory/legend_wolfsbane_necklace_item"));
		// stash.add(this.new("scripts/items/accessory/oathtaker_skull_01_item"));
		// stash.add(this.new("scripts/items/accessory/oathtaker_skull_02_item"));
		// stash.add(this.new("scripts/items/accessory/orc_trophy_item"));
		// stash.add(this.new("scripts/items/accessory/sergeant_badge_item"));
		// stash.add(this.new("scripts/items/accessory/undead_trophy_item"));
	}
